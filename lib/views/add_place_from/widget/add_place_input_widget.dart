...
import '../../../base/utils/custom_style.dart';
import '../../../base/utils/dimensions.dart';
import '../../../base/utils/size.dart';
import '../../../base/widgets/custom_image_widget.dart';
...
class AddPlaceInputWidget extends StatefulWidget {
  ...
  @override
  State<AddPlaceInputWidget> createState() => _AddPlaceInputWidgetState();
}

class _AddPlaceInputWidgetState extends State<AddPlaceInputWidget> {
  FocusNode? focusNode;
