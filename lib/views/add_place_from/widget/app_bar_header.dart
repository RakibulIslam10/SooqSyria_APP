...
class ReUseAppBarHeader extends GetView<AddPlaceFromController> {
  final String subTitle;

  const ReUseAppBarHeader( this.subTitle, {super.key});
      ...
      children: [
        Row(
          ...
          children: [
            ...
            TextWidget(  Strings.placeAnAdd, fontWeight: FontWeight.bold),
            SizedBox(),
          ],
        ),
